...
impl CardCreate {
    pub fn new(card_id: String, char_id: String, rarity: String, name: String, name_normalized: String, link_name: String, link_name_normalized: String, card_type: models::CardType, main_color: String) -> CardCreate {
        CardCreate {
            card_id,
            char_id,
            rarity,
